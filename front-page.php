    ...
    <div class="max-w-7xl mx-auto px-4 w-full relative z-20">
        <div class="max-w-4xl">
            ...
            <div class="flex flex-col sm:flex-row gap-4 mt-8">
                ...
                ?>
                <button id="hero-call-cta" class="clarkes-cta-button border border-eco-green text-eco-green rounded-full px-6 py-3 text-base font-semibold hover:bg-eco-green hover:!text-white transition-all duration-200 text-center whitespace-nowrap focus-visible:outline focus-visible:outline-2 focus-visible:outline-eco-green cursor-pointer" style="transition: all 0.2s ease;" data-phone="<?php echo esc_attr($phone); ?>" data-phone-clean="<?php echo esc_attr($phone_clean); ?>" data-wa-url="<?php echo esc_attr($wa_url); ?>" onmouseover="this.style.color='white';" onmouseout="this.style.color='';">
    ...
    <div class="max-w-7xl mx-auto px-4">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="text-center mb-10">
                ...
                $wa_url = 'https://wa.me/' . $wa_clean . '?text=' . $wa_prefill;
                ?>
                <button id="contact-call-cta" class="clarkes-cta-button inline-block border border-eco-green text-eco-green rounded-full px-8 py-4 text-lg font-semibold hover:bg-eco-green hover:!text-white transition-all duration-200 cursor-pointer" style="transition: all 0.2s ease;" data-phone="<?php echo esc_attr($phone); ?>" data-phone-clean="<?php echo esc_attr($phone_clean); ?>" data-wa-url="<?php echo esc_attr($wa_url); ?>" onmouseover="this.style.color='white';" onmouseout="this.style.color='';">
                    Call <?php echo esc_html($phone); ?>
                </button>
            </div>
