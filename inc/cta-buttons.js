...
(function() {
    ...
    // Create modal for call/WhatsApp options
    function createCTAModal(phone, phoneClean, waUrl) {
        ...
        modal.innerHTML = `
            <div style="background: white; border-radius: 16px; padding: 24px; max-width: 400px; width: 90%; margin: 20px;">
                ...
                <div style="display: flex; flex-direction: column; gap: 12px;">
                    ...
                    <button id="cta-wa-message" style="display: flex; align-items: center; gap: 12px; padding: 14px; background: #f3f4f6; border: none; border-radius: 8px; text-align: left; cursor: pointer; color: #1f2937; transition: background 0.2s;">
        ...
        const waBtn = modal.querySelector('#cta-wa-message');
